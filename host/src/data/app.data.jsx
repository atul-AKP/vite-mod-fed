...
export const nestedList = [
  { id: 1, text: 'Smart converter iOS' },
  { id: 2, text: 'Smart converter Android' },
  { id: 3, text: 'Smart converter' },
  { id: 4, text: 'Best Communities' },
  { id: 5, text: 'Communities' },
  { id: 6, text: 'About Smart' },
  { id: 7, text: 'Careers' },
  { id: 8, text: 'Press' }
]
...
export const sideListItems = [
  ...
  { id: 7, text: 'r/redux', icon: <TbBrandTinder size={24} /> },
